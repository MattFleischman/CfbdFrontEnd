...
const pageNavMap = {'Matchups': '/matchUp', 'Conjecture History': '/history', 'Data Lexicon': '/lexicon', 'Contact Us': '/contact'}
...
export default function AppHeader(props) {
  ...
  const handlePageRedirect = (page) => {
    setAnchorElNav(null);
    setNavPath(pageNavMap[page]);
    setNavigate(true)
    console.log(`in handlePageRedirect`);
        ...
        <AppBar position="static">
          <Container maxWidth="xl">
            <Toolbar disableGutters>
              <img src={spruceTreeLogo} style={{height:20, width:13, margin: 5}}></img>
              <Typography
                variant="h6"
                noWrap
                component="a"
